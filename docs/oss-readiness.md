...
- Baseline examples for PR review, issue triage, CI failure diagnosis, release readiness, OpenAI docs answers, and web extraction boundaries.
...
- [ ] Add 10 baseline eval cases. Current: 6.
- [x] Add `CHANGELOG.md`.
