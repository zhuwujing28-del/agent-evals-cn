...
| `docs/application-evidence-snapshot-2026-09-06.md` | 2026-09-06 公开状态、CI 和申请证据边界快照 |
...
- 用最新的 [application evidence snapshot](docs/application-evidence-snapshot-2026-09-06.md)
  复核公开仓库状态、CI 证据和采用声明边界。
