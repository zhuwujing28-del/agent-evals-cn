...
目标能力：
Evaluate whether Codex can review a local Codex skills repository for installability before a public OSS application or release, without inventing unsupported marketplace or installer behavior.
